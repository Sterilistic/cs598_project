...
def setseed(seed):
    ...
    # CPU-only run: keep CUDA seed calls disabled to avoid touching GPU runtime.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        choices=["mimic01", "mimic02", "ace04", "ace05", "scierc"],
    )
    ...
    parser.add_argument(
        "--num_epoch", type=int, default=50, help="number of the training epochs"
    )
    parser.add_argument(
        "--print_loss_step",
        type=int,
    ...
    parser.add_argument("--do_aug", action="store_true", help="whether to do_aug")
    ...
    parser.add_argument(
        "--test_pred_filename",
        type=str,
        default="ent_pred_mimic_headct.json",
